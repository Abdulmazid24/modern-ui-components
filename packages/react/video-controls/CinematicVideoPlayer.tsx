...
export const CinematicVideoPlayer = React.forwardRef<any, CinematicVideoPlayerProps>(({ className, src = "https://www.w3schools.com/html/mov_bbb.mp4", poster = "https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=1000&auto=format&fit=crop", ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("relative w-full max-w-3xl aspect-video rounded-3xl overflow-hidden bg-black shadow-[0_0_50px_rgba(0,0,0,0.8)] border border-white/10 group", className)}
