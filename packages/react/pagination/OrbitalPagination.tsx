...
export const OrbitalPagination = React.forwardRef<any, OrbitalPaginationProps>(({ className, currentPage, totalPages, onPageChange, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("relative w-full max-w-sm h-[120px] flex items-center justify-center mt-10", className)}>
