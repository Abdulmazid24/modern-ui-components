...
export const GanttTimeline = React.forwardRef<any, GanttTimelineProps>(({ className, tasks = [
          ...
          ], totalDays = 30, ...props }, ref) => {
        return (
        <div ref={ref} {...props} className={cn("w-full max-w-5xl bg-zinc-950 border border-zinc-900 rounded-3xl p-6 shadow-2xl overflow-x-auto scrollbar-thin scrollbar-thumb-zinc-800 relative", className)}>
