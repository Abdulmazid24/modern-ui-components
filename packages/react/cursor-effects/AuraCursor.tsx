...
export const AuraCursor = React.forwardRef<any, any>(({ className, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn(className)}  ref={ref} onMouseMove={handleMove} className="relative w-full max-w-2xl h-64 rounded-2xl overflow-hidden bg-zinc-950 border border-white/8 cursor-none">
