...
export const GlassLoginForm = React.forwardRef<any, GlassLoginFormProps>(({ className, backgroundUrl = "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&h=800&fit=crop", onLogin, onRegister, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("relative w-full max-w-4xl h-[500px] rounded-3xl overflow-hidden mx-auto", className)}
