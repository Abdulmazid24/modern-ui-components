...
export const ScrambleText = React.forwardRef<any, ScrambleTextProps>(({ text, characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*()_+', speed = 40, delay = 500, className = '', ...props }, ref) => {
