...
export const MaskSpotlight = React.forwardRef<any, any>(({ className, children, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn(className)}  ref={ref} onMouseMove={handleMove} className="relative w-full max-w-2xl h-64 rounded-2xl overflow-hidden cursor-none" style={{ background: "#09090b" }}>
