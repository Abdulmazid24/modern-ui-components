...
export const KineticOrigamiCard: React.FC<KineticOrigamiCardProps> = ({
  title = "KINETIC DATA",
}) => {
  const [isHovered, setIsHovered] = useState(false);

  return (
    <div className="flex items-center justify-center p-20 bg-zinc-950 min-h-[600px]" style={{ perspective: 2000 }}>
