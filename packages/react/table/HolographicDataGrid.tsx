...
export const HolographicDataGrid = React.forwardRef<any, HolographicDataGridProps>(({ className, columns, data, ...props }, ref) => {
        const [hoveredRowId, setHoveredRowId] = useState<string | null>(null);

        return (
        <div ref={ref} {...props} className={cn("w-full max-w-4xl mx-auto border border-cyan-900/40 rounded-3xl bg-zinc-950/80 backdrop-blur-md overflow-hidden relative shadow-[0_0_50px_rgba(6,182,212,0.05)]", className)}>
