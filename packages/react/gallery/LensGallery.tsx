...
export const LensGallery = React.forwardRef<any, LensGalleryProps>(({ className, images, ...props }, ref) => {
        const [hoveredId, setHoveredId] = useState<string | null>(null);

        return (
        <div ref={ref} {...props} className={cn("w-full max-w-5xl mx-auto p-4 flex gap-2 h-[400px]", className)}>
          {images.map((image) => {
