...
export const NeuralTypingInput = React.forwardRef<any, NeuralTypingInputProps>(({ className, placeholder = "Enter access code...", onChange, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("relative flex items-center justify-center p-8 bg-black w-full max-w-md mx-auto", className)}>
