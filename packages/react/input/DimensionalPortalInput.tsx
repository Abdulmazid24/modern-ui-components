...
export const DimensionalPortalInput: React.FC<DimensionalPortalInputProps> = ({
  ...
  return (
    <div className="relative flex items-center justify-center p-12 bg-black min-h-[300px]">
      <motion.div
