 ...
 */
export const DynamicIslandNav = React.forwardRef<any, DynamicIslandNavProps>(({ className, items, defaultActive, onChange, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("island-nav-wrapper", className)}>
