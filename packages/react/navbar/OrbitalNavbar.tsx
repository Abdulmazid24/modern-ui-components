...
export const OrbitalNavbar = React.forwardRef<any, OrbitalNavbarProps>(({ className, items, centerIcon, defaultActive, onChange, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("orbital-nav-container", className)}>
          {/* Orbital ring */}
