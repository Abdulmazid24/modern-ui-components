...
export const SonicMediaPlayer = React.forwardRef<any, SonicMediaPlayerProps>(({ className, title = "Cyberflux Protocol", artist = "Vector Synth", coverImage = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop", ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("relative w-full max-w-sm rounded-[2.5rem] bg-zinc-950/80 backdrop-blur-3xl border border-zinc-800/50 p-6 shadow-2xl overflow-hidden group", className)}>
