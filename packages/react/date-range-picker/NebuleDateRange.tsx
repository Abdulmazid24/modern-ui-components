...
export const NebuleDateRange = React.forwardRef<any, any>(({ className, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("w-80 p-5 rounded-2xl bg-zinc-900 border border-white/8", className)}>
