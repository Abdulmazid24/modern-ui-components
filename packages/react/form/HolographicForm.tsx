...
export const HolographicForm = React.forwardRef<any, any>(({ className, ...props }, ref) => {
        return (
        <div ref={ref} {...props} className={cn("w-full max-w-md p-8 rounded-2xl bg-zinc-900/60 border border-white/8 backdrop-blur-xl", className)} style={{ boxShadow: "0 20px 50px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.05)" }}>
