...
export const CrystallineAccordion = React.forwardRef<any, CrystallineAccordionProps>(({ className, items, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("w-full max-w-2xl flex flex-col gap-4", className)}>
          {items.map((item) => (
