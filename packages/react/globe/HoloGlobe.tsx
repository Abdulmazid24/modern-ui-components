...
export const HoloGlobe = React.forwardRef<any, HoloGlobeProps>(({ className, locations = [
        ...
        return (
        <div ref={ref} {...props} className={cn("relative w-full max-w-lg aspect-square bg-zinc-950 border border-zinc-900 rounded-[3rem] shadow-[0_0_50px_rgba(0,0,0,0.8)] flex items-center justify-center p-8 overflow-hidden group", className)}>
