...
export const QuantumDataTable = React.forwardRef<any, any>(({ className, ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("w-full max-w-2xl rounded-2xl border border-white/8 overflow-hidden bg-zinc-900/60 backdrop-blur-xl", className)}>
