...
export const AuroraInput = React.forwardRef<HTMLDivElement, AuroraInputProps>(
  ({ label, helperText, error, inputSize = 'md', icon, className = '', ...props }, ref) => {
    ...
    return (
      <div ref={ref} {...props} className={cn("aurora-input-group", className)}>
        {label && (
        ...
        >
          ...
          <div className={`aurora-input-inner ${sizeClasses[inputSize]}`}>
            ...
            <input
              ...
              {...props as any} // The input itself should probably get standard attributes too, but the root div has props now. Usually we split them.
            />
          </div>
        </div>
...
export const AuroraTextarea = React.forwardRef<HTMLDivElement, AuroraTextareaProps>(
