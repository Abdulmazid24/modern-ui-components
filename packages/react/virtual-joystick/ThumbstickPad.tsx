...
export const ThumbstickPad = React.forwardRef<any, ThumbstickPadProps>(({ className, onChange, ...props }, ref) => {
        ...
        */
        ...
        return (
        <div ref={ref} {...props} className={cn("w-full max-w-sm h-80 bg-zinc-950 border border-zinc-900 rounded-[3rem] shadow-2xl flex flex-col items-center justify-center p-8 gap-8", className)}>
