...
export const AddToCartButton = React.forwardRef<any, AddToCartButtonProps>(({ className, label = "Add to cart", onAdd, variant = "dark", ...props }, ref) => {
...
export const AddToCartButtonDemo = React.forwardRef<any, AddToCartButtonProps>(({ className, ...props }, ref) => {
        (
