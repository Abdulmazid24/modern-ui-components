...
export const BioluminescentMycelium = React.forwardRef<any, BioluminescentMyceliumProps>(({ className, progress = 50, color = "100, 255, 150", ...props }, ref) => {
        ...
        return (
        <div ref={ref} {...props} className={cn("flex flex-col items-center justify-center p-12 bg-black min-h-[300px]", className)}>
